...
function showCancelPopup(reason, order) {
    ...
    popup.innerHTML = `
        ...
        <p style="font-weight:bold">${reason || "Order cancelled by admin"}</p>

        <div style="margin-top:20px;display:flex;gap:10px;">
            <button id="reorderBtnPopup"
                style="flex:2;background:#28a745;color:white;padding:10px;border:none;border-radius:5px;cursor:pointer;">
                Reorder
            </button>

            <button id="closeCancelPopup"
                style="flex:1;background:#6c757d;color:white;padding:10px;border:none;border-radius:5px;cursor:pointer;">
                Close
            </button>
        </div>
    `;
    ...
    document.getElementById("reorderBtnPopup").onclick = () => {
    ...
    document.getElementById("closeCancelPopup").onclick = () => {
        popup.remove();
    };
}
